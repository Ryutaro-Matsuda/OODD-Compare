...
test_mahalanobis(model_ood, test_loader_cifar100, test_loader_cifar10)

print("=== テスト②（FAR_OOD:SVHN）===")
test_mahalanobis(model_ood, test_loader_cifar100, test_loader_svhn)

print("=== テスト③（FAR_OOD:LSUN）===")
test_mahalanobis(model_ood, test_loader_cifar100, test_loader_lsun)

print("=== テスト②（FAR_OOD:MNIST）===")
test_mahalanobis(model_ood, test_loader_cifar100, test_loader_mnist)